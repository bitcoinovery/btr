...
* WebSocket: [https://github.com/btrpay/insight-api-btr#web-socket-api](https://github.com/btrpay/insight-api-btr#web-socket-api)
* API: [https://github.com/btrpay/insight-api-btr#instantsend-transactions](https://github.com/btrpay/insight-api-btr#instantsend-transactions)
...
By default, the BTR Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BTR Core daemon:
