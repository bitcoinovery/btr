...
Only requiring some minor changes is btr.cpp.
...
Changes to btr.cpp
----------------------
btr.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
