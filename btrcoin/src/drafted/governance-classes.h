 ...
 *
 *   // network
 *   CBTRNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.btr.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBTRNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BTRNetwork
// //   -- signature requirements : Key1(User)
// class CBTRNetworkVariable : public CGovernanceObject
// {
// private:
