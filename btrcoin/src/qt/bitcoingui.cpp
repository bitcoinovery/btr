    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BTR Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BTR: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BTR Core"), this);
    aboutAction->setStatusTip(tr("Show information about BTR Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BTR Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BTR Core help message to get a list with possible BTR Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BTR Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BTR Core"); // default title
