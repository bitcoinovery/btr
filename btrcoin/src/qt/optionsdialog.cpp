    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BTR-light"), QVariant("light"));
    ui->theme->addItem(QString("BTR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BTR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BTR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BTR-traditional"), QVariant("trad"));
