...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizeBTRAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizeBTRAmount").toInt());
    }
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in btr.cpp during shotdown to also remove the window positions
