    ...
    timer(nullptr)
{
    ...
    ui->labelPrivateSendHeader->setVisible(false);

    ui->labelPrivateSendSyncStatus->setVisible(false);
    ui->labelPrivateSendEnabled->setVisible(false);
    ui->labelPrivateSendEnabledText->setVisible(false);
    ui->labelCompletitionText->setVisible(false);

    ui->framePrivateSend->setVisible(false);
    ui->privateSendProgress->setVisible(false);
    ui->labelAnonymizedText->setVisible(false);
    ui->labelAnonymized->setVisible(false);
    ui->labelAmountAndRoundsText->setVisible(false);
    ui->labelAmountRounds->setVisible(false);
    ui->labelSubmittedDenomText->setVisible(false);
    ui->labelSubmittedDenom->setVisible(false);
    ui->labelPrivateSendLastMessage->setVisible(false);
    ui->togglePrivateSend->setVisible(false);


    ui->privateSendAuto->setVisible(false);
    ui->privateSendReset->setVisible(false);
