    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextBTR   = QChar(0xA9)+QString(" 2018-2028 ")/*.arg(COPYRIGHT_YEAR)*/ + QString(tr("The BTR Core developers"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace+12,copyrightTextBTR);
