    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BTR Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BTR Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  BTR-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BTR in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BTR, 0.1 BTR, 1 BTR and 10 BTR -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://btrpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://btrpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BTR Core is shutting down...") + "<br /><br />" +
